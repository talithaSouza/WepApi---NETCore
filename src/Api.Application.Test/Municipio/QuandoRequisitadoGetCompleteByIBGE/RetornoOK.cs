...
namespace Api.Application.Test.Municipio.QuandoRequisitadoGetCompleteByIBGE
{
    public class RetornoOK
    {
        ...
        [Fact(DisplayName = "Retorno OK Metodo Get Complete By IBGE de municipio")]
        public async Task RetornoOK_MetodoGetCompleteByIbgeMunicipio()
        {
            ...
            var result = await _controller.GetCompleteByIBGE(Faker.RandomNumber.Next(100000, 999999));
